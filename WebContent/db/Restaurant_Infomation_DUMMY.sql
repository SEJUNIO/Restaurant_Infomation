...
INSERT INTO BOARD (BID, MID, AID, BTITLE, BCONTENT, BHIT, BPW, BGROUP, BSTEP, bINDENT, BIP)
    VALUES (1, 'aaa', 'abc', '제목1', '냉무1', '111', '111', '111', 0, 0, '192.168.5.4');
INSERT INTO BOARD (BID, MID, AID, BTITLE, BCONTENT, BHIT, BPW, BGROUP, BSTEP, bINDENT, BIP)
    VALUES (2, 'gayun', 'abc', '제목2', '냉무2', '111', '111', '111', 0, 0, '192.168.6.4');
INSERT INTO BOARD (BID, MID, AID, BTITLE, BCONTENT, BHIT, BPW, BGROUP, BSTEP, bINDENT, BIP)
    VALUES (3, 'gico', 'abc', '제목3', '냉무3', '111', '111', '111', 0, 0, '192.168.7.4');
INSERT INTO BOARD (BID, MID, AID, BTITLE, BCONTENT, BHIT, BPW, BGROUP, BSTEP, bINDENT, BIP)
    VALUES (4, 'go', 'abc', '제목4', '냉무4', '111', '111', '111', 0, 0, '192.168.8.4');
INSERT INTO BOARD (BID, MID, AID, BTITLE, BCONTENT, BHIT, BPW, BGROUP, BSTEP, bINDENT, BIP)
    VALUES (5, 'son', 'abc', '제목5', '냉무5', '111', '111', '111', 0, 0, '192.168.9.4');
INSERT INTO BOARD (BID, MID, AID, BTITLE, BCONTENT, BHIT, BPW, BGROUP, BSTEP, bINDENT, BIP)
    VALUES (6, 'han', 'abc', '제목6', '냉무6', '111', '111', '111', 0, 0, '192.168.5.5');
INSERT INTO BOARD (BID, MID, AID, BTITLE, BCONTENT, BHIT, BPW, BGROUP, BSTEP, bINDENT, BIP)
    VALUES (7, 'kim', 'abc', '제목7', '냉무7', '111', '111', '111', 0, 0, '192.168.5.6');
INSERT INTO BOARD (BID, MID, AID, BTITLE, BCONTENT, BHIT, BPW, BGROUP, BSTEP, bINDENT, BIP)
    VALUES (8, 'park', 'abc', '제목8', '냉무8', '111', '111', '111', 0, 0, '192.168.5.7');
INSERT INTO BOARD (BID, MID, AID, BTITLE, BCONTENT, BHIT, BPW, BGROUP, BSTEP, bINDENT, BIP)
    VALUES (9, 'sol', 'abc', '제목9', '냉무9', '111', '111', '111', 0, 0, '192.168.5.8');
...
INSERT INTO RESTAURANT (RNO, RNAME, CNO, RADDRESS, RTEL, RHOLIDAY, RPARKING)
    VALUES (1, '치즈플로', 'WESTERNFOOD', '서울 강남구', '02-822-1029', '금요일', '발렛');
INSERT INTO RESTAURANT (RNO, RNAME, CNO, RADDRESS, RTEL, RHOLIDAY, RPARKING)
    VALUES (2, '오월의종', 'BAKERY', '서울 이태원', '02-749-9481', '월요일,일요일', '없음');
INSERT INTO RESTAURANT (RNO, RNAME, CNO, RADDRESS, RTEL, RHOLIDAY, RPARKING)
    VALUES (3, '탄산바', 'DESERT', '서울 이태원', '02-794-4486', '없음', '없음');
INSERT INTO RESTAURANT (RNO, RNAME, CNO, RADDRESS, RTEL, RHOLIDAY, RPARKING)
    VALUES (4, '데이로우', 'DESERT', '서울 이태원', '02-790-1767', '월요일', '발렛');
INSERT INTO RESTAURANT (RNO, RNAME, CNO, RADDRESS, RTEL, RHOLIDAY, RPARKING)
    VALUES (5, '제니엘 디저트바', 'DESERT', '서울 이태원', '02-822-1029', '금요일', '발렛');
INSERT INTO RESTAURANT (RNO, RNAME, CNO, RADDRESS, RTEL, RHOLIDAY, RPARKING)
    VALUES (6, '부자피자', 'KOREANFOOD', '서울 이태원', '02-822-1029', '없음', '없음');
INSERT INTO RESTAURANT (RNO, RNAME, CNO, RADDRESS, RTEL, RHOLIDAY, RPARKING)
    VALUES (7, '빠르크', 'KOREANFOOD', '서울 이태원', '02-792-2022', '없음', '발렛');
INSERT INTO RESTAURANT (RNO, RNAME, CNO, RADDRESS, RTEL, RHOLIDAY, RPARKING)
    VALUES (8, '루트에브리데이', 'WESTERNFOOD', '서울 강남구', '	02-797-9505', '월요일', '없음');
INSERT INTO RESTAURANT (RNO, RNAME, CNO, RADDRESS, RTEL, RHOLIDAY, RPARKING)
    VALUES (9, 'YYY', 'WESTERNFOOD', '서울 이태원', '070-4213-2061', '없음', '발렛');
